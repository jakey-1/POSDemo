...
namespace POSDemo {
    ...
    public partial class POSTutDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductRow AddProductRow(string Name, string Code, decimal Price, int Quantity, string Notes) {
...
namespace POSDemo.POSTutDataSetTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Product] ([Name], [Code], [Price], [Quantity], [Notes]) VALUES" +
                " (@Name, @Code, @Price, @Quantity, @Notes);\r\nSELECT Id, Name, Code, Price, Quant" +
                "ity, Notes FROM Product WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Product] SET [Name] = @Name, [Code] = @Code, [Price] = @Price, [Quantity] = @Quantity, [Notes] = @Notes WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Code = 1 AND [Code] IS NULL) OR ([Code] = @Original_Code)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)));
SELECT Id, Name, Code, Price, Quantity, Notes FROM Product WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Code, Price, Quantity, Notes FROM dbo.Product";
        ...
        public virtual int Fill(POSTutDataSet.ProductDataTable dataTable) {
        ...
        public virtual POSTutDataSet.ProductDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            POSTutDataSet.ProductDataTable dataTable = new POSTutDataSet.ProductDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(POSTutDataSet.ProductDataTable dataTable) {
        ...
        public virtual int Insert(string Name, string Code, global::System.Nullable<decimal> Price, global::System.Nullable<int> Quantity, string Notes) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Code, global::System.Nullable<decimal> Price, global::System.Nullable<int> Quantity, string Notes, int Original_Id, string Original_Name, string Original_Code, global::System.Nullable<decimal> Original_Price, global::System.Nullable<int> Original_Quantity, int Id) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Code, global::System.Nullable<decimal> Price, global::System.Nullable<int> Quantity, string Notes, int Original_Id, string Original_Name, string Original_Code, global::System.Nullable<decimal> Original_Price, global::System.Nullable<int> Original_Quantity) {
            return this.Update(Name, Code, Price, Quantity, Notes, Original_Id, Original_Name, Original_Code, Original_Price, Original_Quantity, Original_Id);
        }
    }
